...
from rospy import init_node, spin, Subscriber, Publisher, loginfo, wait_for_service, \
...
class Node2():
     ...
     def __init__(self):
         ...
         print "Node2: receiving messages on topic 'initial_data', publishing messages on topic 'final_data'"
